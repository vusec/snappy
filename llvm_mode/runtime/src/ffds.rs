...
#[no_mangle]
pub unsafe extern "C" fn __angora_io_add_pfile(pfile: *mut libc::FILE) {
    let fd = libc::fileno(pfile);
...
#[no_mangle]
pub unsafe extern "C" fn __angora_io_remove_pfile(pfile: *mut libc::FILE) {
    let fd = libc::fileno(pfile);
...
#[no_mangle]
pub unsafe extern "C" fn __angora_io_find_pfile(pfile: *mut libc::FILE) -> u32 {
    let fd = libc::fileno(pfile);
